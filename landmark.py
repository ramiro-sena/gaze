...
for landmark in landmarks:
    ...
    for x,y in landmark[0]:
        cv2.putText(image,f'{i}', (int(x), int(y)), cv2.FONT_HERSHEY_PLAIN, 1,(0,0,255),1)
...
left_eye_region = np.array([(int(landmarks[0][0][36][0]), int(landmarks[0][0][36][1])),
                            (int(landmarks[0][0][37][0]), int(landmarks[0][0][37][1])),
                            (int(landmarks[0][0][38][0]), int(landmarks[0][0][38][1])),
                            (int(landmarks[0][0][39][0]), int(landmarks[0][0][39][1])),
                            (int(landmarks[0][0][40][0]), int(landmarks[0][0][40][1])),
...
right_eye_region = np.array([(int(landmarks[0][0][43][0]), int(landmarks[0][0][43][1])),
                            (int(landmarks[0][0][44][0]), int(landmarks[0][0][44][1])),
                            (int(landmarks[0][0][45][0]), int(landmarks[0][0][45][1])),
                            (int(landmarks[0][0][46][0]), int(landmarks[0][0][46][1])),
                            (int(landmarks[0][0][47][0]), int(landmarks[0][0][47][1])),
